# Generated by Django 4.1.4 on 2023-03-19 09:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(default=None, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('commented_on', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commented_post', to='network.post')),
